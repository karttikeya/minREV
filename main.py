...
parser.add_argument('--epochs', default=200, type=int, help='number of classes in the dataset')

# Transformer options 
parser.add_argument('--embed_dim', default=256, type=int, help='embedding dimension of the transformer')
parser.add_argument('--n_head', default=8, type=int, help='number of heads in the transformer')
parser.add_argument('--depth', default=4, type=int, help='number of transformer blocks')
parser.add_argument('--patch_size', default=(4, 4), help='patch size in patchification')
...
parser.add_argument('--vanilla_bp', default=False, type=bool, help='whether to use reversible backpropagation or not')
...
model = RevViT(embed_dim = args.embed_dim, 
            n_head = args.n_head, 
            depth = args.depth, 
